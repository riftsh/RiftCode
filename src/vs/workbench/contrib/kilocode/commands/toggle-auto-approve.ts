...
import type { KiloClient, Event } from "@riftcode/sdk/v2/client"
...
const CONFIG = "rift-ai.new.autoApprove"
const KEY = "enabled"
...
export function registerToggleAutoApprove(
  ...
  context.subscriptions.push(vscode.commands.registerCommand("rift-ai.new.toggleAutoApprove", toggle))
