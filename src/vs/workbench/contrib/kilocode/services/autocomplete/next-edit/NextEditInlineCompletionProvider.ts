...
const INLINE_COMPLETION_ACCEPTED_COMMAND = "rift-ai.new.autocomplete.nextEdit.accepted"
const DEFAULT_DEBOUNCE_MS = 250

export interface NextEditProviderDeps {
  /** Routes Mercury calls through the local Kilo gateway (handles auth + BYOK). */
  connectionService: KiloConnectionService
  /** Optional source of recently-viewed snippets (riftcode's VisibleCodeTracker can adapt to this). */
