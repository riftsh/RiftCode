...
async function loadLanguageForFileExt(fileExtension: string): Promise<Language> {
  ...
  // In production (compiled): __dirname = /path/to/riftcode/src/dist or dist/
  // In development: __dirname = /path/to/riftcode/src/services/autocomplete/continuedev/core/util
  const candidatePaths: string[] = [
