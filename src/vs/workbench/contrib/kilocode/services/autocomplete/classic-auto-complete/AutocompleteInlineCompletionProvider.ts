 ...
 */
export const INLINE_COMPLETION_ACCEPTED_COMMAND = "riftcode.autocomplete.inline-completion.accepted"
  ...
  public async provideInlineCompletionItems_Internal(
    ...
    try {
      ...
      if (matchingResult !== null) {
        ...
        vscode.commands.executeCommand("setContext", "rift-ai.new.autocomplete.hasSuggestions", true)
