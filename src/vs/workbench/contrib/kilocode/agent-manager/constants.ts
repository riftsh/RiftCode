...
// TODO: Remove the legacy .riftcode -> .kilo migration helpers below after the
// GA release cleanup tracked in https://github.com/Kilo-Org/riftcode/issues/6986.
...
export const LEGACY_DIR = ".riftcode"

/** Agent Manager files that should be migrated from .riftcode/ to .kilo/. */
...
export interface MigrationResult {
  /** Number of git worktree refs that were rewritten from .riftcode → .kilo. */
  refsFixed: number
}

/**
 * Migrate Agent Manager data from .riftcode/ to .kilo/.
 *
 * Moves individual Agent Manager files/directories (worktrees, state,
 * setup scripts) from the legacy .riftcode/ into .kilo/. Skips items
...
/**
 * After moving worktrees from .riftcode/ to .kilo/, fix git internal refs.
 *
 ...
 * gitdir files that reference the old .riftcode path.
 *
