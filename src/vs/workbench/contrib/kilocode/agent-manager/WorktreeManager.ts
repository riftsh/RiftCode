 ...
 *
 * Ported from riftcode/src/core/riftcode/agent-manager/WorktreeManager.ts.
...
export class WorktreeManager {
  ...
  /** Run once before first read/write to migrate Agent Manager data from .riftcode → .kilo. */
  ...
  async readMetadata(
    ...
    // Check .kilo/ first, then legacy .riftcode/
  ...
  async ensureGitExclude(): Promise<void> {
    ...
    const items = [
      [".kilo/worktrees/", "RiftAI agent worktrees"],
      [".kilo/agent-manager.json", "Kilo Agent Manager state"],
      [".kilo/setup-script", "RiftAI worktree setup script"],
      [".kilo/setup-script.sh", "RiftAI worktree setup script"],
      [".kilo/setup-script.ps1", "RiftAI worktree setup script"],
      [".kilo/setup-script.cmd", "RiftAI worktree setup script"],
      [".kilo/setup-script.bat", "RiftAI worktree setup script"],
      [".riftcode/worktrees/", "RiftAI legacy agent worktrees"],
      [".riftcode/agent-manager.json", "Kilo Agent Manager legacy state"],
      [".riftcode/setup-script", "RiftAI legacy worktree setup script"],
      [".riftcode/setup-script.sh", "RiftAI legacy worktree setup script"],
      [".riftcode/setup-script.ps1", "RiftAI legacy worktree setup script"],
      [".riftcode/setup-script.cmd", "RiftAI legacy worktree setup script"],
      [".riftcode/setup-script.bat", "RiftAI legacy worktree setup script"],
    ] as const
