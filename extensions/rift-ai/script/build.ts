...
const targets = [
  { target: "linux-x64", cliDir: "@riftcode/cli-linux-x64", binary: "kilo" },
  { target: "linux-arm64", cliDir: "@riftcode/cli-linux-arm64", binary: "kilo" },
  { target: "alpine-x64", cliDir: "@riftcode/cli-linux-x64-musl", binary: "kilo" },
  { target: "alpine-arm64", cliDir: "@riftcode/cli-linux-arm64-musl", binary: "kilo" },
  { target: "darwin-x64", cliDir: "@riftcode/cli-darwin-x64", binary: "kilo" },
  { target: "darwin-arm64", cliDir: "@riftcode/cli-darwin-arm64", binary: "kilo" },
  { target: "win32-x64", cliDir: "@riftcode/cli-windows-x64", binary: "kilo.exe" },
  { target: "win32-arm64", cliDir: "@riftcode/cli-windows-arm64", binary: "kilo.exe" },
]
