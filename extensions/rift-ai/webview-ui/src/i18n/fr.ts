export const dict = {
  ...
  "settings.config.source.homeKilocode": "Configuration .riftcode de Home",
  ...
  "settings.config.source.projectKilocode": "Configuration obsolète .riftcode",
  ...
  "deviceAuth.title": "Se connecter à RiftAI",
  ...
  "profile.action.login": "Se connecter avec RiftAI",
  ...
  "settings.aboutRiftCode.title": "À propos de RiftAI",

  "session.messages.empty": "Commencez une conversation en tapant un message ci-dessous.",
  "session.messages.welcome":
    "RiftAI est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.aboutRiftCode.status.connected": "Connecté",
  "settings.aboutRiftCode.status.connecting": "Connexion en cours...",
  "settings.aboutRiftCode.status.disconnected": "Déconnecté",
  "settings.aboutRiftCode.status.error": "Erreur",
  "settings.aboutRiftCode.cliServer": "Serveur CLI",
  "settings.aboutRiftCode.status.label": "Statut :",
  "settings.aboutRiftCode.port.label": "Port :",
  "settings.aboutRiftCode.versionInfo": "Informations de version",
  "settings.aboutRiftCode.version.label": "Version :",
  "settings.aboutRiftCode.extensionName": "Extension RiftAI",
  "settings.aboutRiftCode.community": "Communauté et support",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Réinitialiser tous les paramètres",
  "settings.aboutRiftCode.settingsTransfer.title": "Transfert des paramètres",
  ...
  "settings.aboutRiftCode.exportSettings": "Exporter",
  ...
  "settings.aboutRiftCode.importSettings.invalidConfig": "Le fichier ne contient pas de paramètres Kilo valides.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Télémétrie",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Ouvrir les paramètres de télémétrie",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de RiftAI. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migration de l'ancienne version",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de RiftAI, y compris les clés d'API des fournisseurs et le modèle par défaut.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de RiftAI",
