export const dict = {
  ...
  "settings.config.source.homeKilocode": "Konfiguracja .riftcode (Home)",
  ...
  "settings.config.source.projectKilocode": "Przestarzała konfiguracja .riftcode",
  ...
  "deviceAuth.title": "Zaloguj się do RiftAI",
  ...
  "profile.action.login": "Zaloguj się przez RiftAI",
  ...
  "settings.aboutRiftCode.title": "O RiftAI",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "RiftAI to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutRiftCode.status.connected": "Połączono",
  "settings.aboutRiftCode.status.connecting": "Łączenie...",
  "settings.aboutRiftCode.status.disconnected": "Rozłączono",
  "settings.aboutRiftCode.status.error": "Błąd",
  "settings.aboutRiftCode.cliServer": "Serwer CLI",
  "settings.aboutRiftCode.status.label": "Status:",
  "settings.aboutRiftCode.port.label": "Port:",
  "settings.aboutRiftCode.versionInfo": "Informacje o wersji",
  "settings.aboutRiftCode.version.label": "Wersja:",
  "settings.aboutRiftCode.extensionName": "Rozszerzenie RiftAI",
  "settings.aboutRiftCode.community": "Społeczność i wsparcie",
  "settings.aboutRiftCode.feedback.prefix": "Jeśli masz pytania lub uwagi, śmiało otwórz zgłoszenie na",
  "settings.aboutRiftCode.feedback.or": "lub",
  "settings.aboutRiftCode.support.prefix":
    "W sprawach rozliczeń lub konta skontaktuj się z obsługą klienta pod adresem",
  "settings.aboutRiftCode.resetSettings.title": "Resetuj ustawienia",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Resetuj wszystkie ustawienia",
  "settings.aboutRiftCode.settingsTransfer.title": "Przenoszenie ustawień",
  ...
  "settings.aboutRiftCode.exportSettings": "Eksportuj",
  "settings.aboutRiftCode.importSettings": "Importuj",
  "settings.aboutRiftCode.importSettings.invalidJson": "Nieprawidłowy plik JSON. Wybierz prawidłowy plik ustawień.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Plik nie zawiera prawidłowych ustawień Kilo.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Plik jest za duży. Pliki ustawień muszą mieć mniej niż 1 MB.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Otwórz ustawienia telemetrii",
  ...
  "settings.language.description": 'Wybierz język interfejsu RiftAI. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migracja starszej wersji",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji RiftAI, w tym klucze API dostawców i domyślny model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w RiftAI",
