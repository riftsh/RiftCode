export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode-configuratie",
  ...
  "settings.config.source.projectKilocode": "Verouderde .riftcode-configuratie",
  ...
  "deviceAuth.title": "Meld je aan bij RiftAI",
  ...
  "profile.action.login": "Inloggen met RiftAI",
  ...
  "settings.aboutRiftCode.title": "Over RiftAI",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "RiftAI is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutRiftCode.status.connected": "Verbonden",
  "settings.aboutRiftCode.status.connecting": "Verbinden...",
  "settings.aboutRiftCode.status.disconnected": "Verbinding verbroken",
  "settings.aboutRiftCode.status.error": "Fout",
  "settings.aboutRiftCode.cliServer": "CLI Server",
  "settings.aboutRiftCode.status.label": "Status:",
  "settings.aboutRiftCode.port.label": "Poort:",
  "settings.aboutRiftCode.versionInfo": "Versie-informatie",
  "settings.aboutRiftCode.version.label": "Versie:",
  "settings.aboutRiftCode.extensionName": "RiftAI Extensie",
  "settings.aboutRiftCode.community": "Community & Ondersteuning",
  "settings.aboutRiftCode.feedback.prefix": "Als je vragen of feedback hebt, voel je vrij om een issue aan te maken op",
  "settings.aboutRiftCode.feedback.or": "of",
  "settings.aboutRiftCode.support.prefix":
    "Voor vragen over facturering of je account, neem contact op met Klantenservice op",
  "settings.aboutRiftCode.resetSettings.title": "Instellingen resetten",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Alle instellingen resetten",
  "settings.aboutRiftCode.settingsTransfer.title": "Instellingen overdragen",
  ...
  "settings.aboutRiftCode.exportSettings": "Exporteren",
  "settings.aboutRiftCode.importSettings": "Importeren",
  "settings.aboutRiftCode.importSettings.invalidJson":
    "Ongeldig JSON-bestand. Selecteer een geldig instellingenbestand.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Het bestand bevat geen geldige Kilo-instellingen.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Telemetrie-instellingen openen",
  ...
  "settings.language.description": 'Kies de taal voor de RiftAI UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Legacy Migratie",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van RiftAI, inclusief provider API-sleutels en standaard model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in RiftAI",
