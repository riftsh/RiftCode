...
export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode 구성",
  ...
  "settings.config.source.projectKilocode": "레거시 .riftcode 구성",
  ...
  "profile.action.login": "RiftAI로 로그인",
  ...
  "settings.aboutRiftCode.title": "RiftAI 정보",
  ...
  "session.messages.welcome":
    "RiftAI는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutRiftCode.status.connected": "연결됨",
  "settings.aboutRiftCode.status.connecting": "연결 중...",
  "settings.aboutRiftCode.status.disconnected": "연결 끊김",
  "settings.aboutRiftCode.status.error": "오류",
  "settings.aboutRiftCode.cliServer": "CLI 서버",
  "settings.aboutRiftCode.status.label": "상태:",
  "settings.aboutRiftCode.port.label": "포트:",
  "settings.aboutRiftCode.versionInfo": "버전 정보",
  "settings.aboutRiftCode.version.label": "버전:",
  "settings.aboutRiftCode.extensionName": "RiftAI 확장 프로그램",
  "settings.aboutRiftCode.community": "커뮤니티 및 지원",
  "settings.aboutRiftCode.feedback.prefix": "질문이나 피드백이 있으시면 다음에서 이슈를 열어주세요",
  "settings.aboutRiftCode.feedback.or": "또는",
  "settings.aboutRiftCode.support.prefix": "결제 또는 계정 관련 문의는 고객 지원팀에 문의하세요",
  "settings.aboutRiftCode.resetSettings.title": "설정 초기화",
  ...
  "settings.aboutRiftCode.resetSettings.button": "모든 설정 초기화",
  "settings.aboutRiftCode.settingsTransfer.title": "설정 이전",
  "settings.aboutRiftCode.settingsTransfer.description":
    "VS Code 인스턴스 간에 설정을 전송하려면 내보내기 또는 가져오기하세요.",
  "settings.aboutRiftCode.exportSettings": "내보내기",
  "settings.aboutRiftCode.importSettings": "가져오기",
  "settings.aboutRiftCode.importSettings.invalidJson":
    "유효하지 않은 JSON 파일입니다. 올바른 설정 파일을 선택해 주세요.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "파일에 유효한 Kilo 설정이 포함되어 있지 않습니다.",
  "settings.aboutRiftCode.importSettings.tooLarge": "파일이 너무 큽니다. 설정 파일은 1 MB 이하여야 합니다.",
  "settings.aboutRiftCode.importSettings.newerVersion":
    "이 파일은 더 최신 버전의 Kilo에서 내보낸 것입니다. 일부 설정이 무시될 수 있습니다.",
  "settings.aboutRiftCode.importSettings.success": "설정을 가져왔습니다. 위의 변경 사항을 확인한 후 저장을 클릭하세요.",

  "settings.aboutRiftCode.telemetry.title": "원격 측정",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "원격 측정 설정 열기",
  ...
  "settings.language.description": 'RiftAI UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "레거시 마이그레이션",
  "settings.aboutRiftCode.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 RiftAI 설치에서 설정을 마이그레이션합니다.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "RiftAI의 새로운 기능",
