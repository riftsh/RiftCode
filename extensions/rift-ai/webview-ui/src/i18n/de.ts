...
export const dict = {
  ...
  "settings.config.source.projectKilocode": "Veraltete .riftcode-Konfiguration",
  ...
  "deviceAuth.title": "Bei RiftAI anmelden",
  ...
  "profile.action.login": "Mit RiftAI anmelden",
  ...
  "settings.aboutRiftCode.title": "Über RiftAI",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "RiftAI ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutRiftCode.status.connected": "Verbunden",
  "settings.aboutRiftCode.status.connecting": "Verbindung wird hergestellt...",
  "settings.aboutRiftCode.status.disconnected": "Getrennt",
  "settings.aboutRiftCode.status.error": "Fehler",
  ...
  "settings.aboutRiftCode.versionInfo": "Versionsinformationen",
  "settings.aboutRiftCode.version.label": "Version:",
  "settings.aboutRiftCode.extensionName": "RiftAI Erweiterung",
  "settings.aboutRiftCode.community": "Community & Support",
  "settings.aboutRiftCode.feedback.prefix": "Bei Fragen oder Feedback können Sie ein Issue eröffnen auf",
  "settings.aboutRiftCode.feedback.or": "oder",
  "settings.aboutRiftCode.support.prefix":
    "Bei Abrechnungs- oder Kontofragen wenden Sie sich an den Kundensupport unter",
  "settings.aboutRiftCode.resetSettings.title": "Einstellungen zurücksetzen",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Alle Einstellungen zurücksetzen",
  "settings.aboutRiftCode.settingsTransfer.title": "Einstellungen übertragen",
  ...
  "settings.aboutRiftCode.exportSettings": "Exportieren",
  "settings.aboutRiftCode.importSettings": "Importieren",
  ...
  "settings.aboutRiftCode.importSettings.invalidConfig": "Die Datei enthält keine gültigen Kilo-Einstellungen.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Telemetrie",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Telemetrie-Einstellungen öffnen",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die RiftAI Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.aboutRiftCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von RiftAI, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in RiftAI",
