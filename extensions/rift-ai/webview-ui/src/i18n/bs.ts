export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode konfiguracija",
  ...
  "settings.config.source.projectKilocode": "Zastarjela .riftcode konfiguracija",
  ...
  "deviceAuth.title": "Prijavite se u RiftAI",
  ...
  "profile.action.login": "Prijavite se putem RiftAI",
  ...
  "settings.aboutRiftCode.title": "O RiftAI-u",

  "session.messages.empty": "Započnite razgovor unosom poruke ispod.",
  "session.messages.welcome":
    "RiftAI je AI asistent za programiranje. Zatražite da gradi funkcionalnosti, ispravlja greške ili objasni vašu bazu koda.",
  ...
  "settings.aboutRiftCode.status.connected": "Povezano",
  "settings.aboutRiftCode.status.connecting": "Povezivanje...",
  "settings.aboutRiftCode.status.disconnected": "Odspojeno",
  "settings.aboutRiftCode.status.error": "Greška",
  ...
  "settings.aboutRiftCode.versionInfo": "Informacije o verziji",
  "settings.aboutRiftCode.version.label": "Verzija:",
  "settings.aboutRiftCode.extensionName": "RiftAI ekstenzija",
  "settings.aboutRiftCode.community": "Zajednica i podrška",
  "settings.aboutRiftCode.feedback.prefix": "Ako imate pitanja ili povratne informacije, slobodno otvorite issue na",
  "settings.aboutRiftCode.feedback.or": "ili",
  "settings.aboutRiftCode.support.prefix": "Za pitanja o naplati ili računu, kontaktirajte korisničku podršku na",
  "settings.aboutRiftCode.resetSettings.title": "Resetovanje postavki",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Resetuj sve postavke",
  "settings.aboutRiftCode.settingsTransfer.title": "Prijenos postavki",
  "settings.aboutRiftCode.settingsTransfer.description":
    "Izvezite ili uvezite postavke za prijenos između VS Code instanci.",
  "settings.aboutRiftCode.exportSettings": "Izvezi",
  "settings.aboutRiftCode.importSettings": "Uvezi",
  "settings.aboutRiftCode.importSettings.invalidJson": "Nevažeći JSON fajl. Odaberite važeći fajl s postavkama.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Fajl ne sadrži važeće Kilo postavke.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Fajl je prevelik. Fajlovi s postavkama moraju biti manji od 1 MB.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Telemetrija",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Otvori postavke telemetrije",
  ...
  "settings.language.description": 'Odaberite jezik za RiftAI sučelje. "Auto" koristi jezik prikaza VS Code-a.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migracija sa prethodne verzije",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migrirajte postavke iz prethodne instalacije RiftAI, uključujući API ključeve provajdera i podrazumijevani model.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Šta je novo u RiftAI",
