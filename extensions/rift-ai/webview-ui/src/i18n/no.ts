...
export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode-konfigurasjon",
  ...
  "settings.config.source.projectKilocode": "Eldre .riftcode-konfigurasjon",
  ...
  "deviceAuth.title": "Logg inn på RiftAI",
  ...
  "profile.action.login": "Logg inn med RiftAI",
  ...
  "settings.aboutRiftCode.title": "Om RiftAI",

  "session.messages.empty": "Start en samtale ved å skrive en melding nedenfor.",
  "session.messages.welcome":
    "RiftAI er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.aboutRiftCode.status.connected": "Tilkoblet",
  "settings.aboutRiftCode.status.connecting": "Kobler til...",
  "settings.aboutRiftCode.status.disconnected": "Frakoblet",
  "settings.aboutRiftCode.status.error": "Feil",
  "settings.aboutRiftCode.cliServer": "CLI-server",
  "settings.aboutRiftCode.status.label": "Status:",
  "settings.aboutRiftCode.port.label": "Port:",
  "settings.aboutRiftCode.versionInfo": "Versjonsinformasjon",
  "settings.aboutRiftCode.version.label": "Versjon:",
  "settings.aboutRiftCode.extensionName": "RiftAI-utvidelse",
  "settings.aboutRiftCode.community": "Fellesskap og støtte",
  "settings.aboutRiftCode.feedback.prefix": "Hvis du har spørsmål eller tilbakemeldinger, åpne gjerne en issue på",
  "settings.aboutRiftCode.feedback.or": "eller",
  "settings.aboutRiftCode.support.prefix": "For fakturerings- eller kontospørsmål, kontakt kundestøtte på",
  "settings.aboutRiftCode.resetSettings.title": "Tilbakestill innstillinger",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Tilbakestill alle innstillinger",
  "settings.aboutRiftCode.settingsTransfer.title": "Overføring av innstillinger",
  ...
  "settings.aboutRiftCode.exportSettings": "Eksporter",
  "settings.aboutRiftCode.importSettings": "Importer",
  "settings.aboutRiftCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vennligst velg en gyldig innstillingsfil.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Filen inneholder ikke gyldige Kilo-innstillinger.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Filen er for stor. Innstillingsfiler må være under 1 MB.",
  ...
  "settings.aboutRiftCode.importSettings.success":
    "Innstillinger importert. Gjennomgå endringene ovenfor, og klikk deretter på Lagre.",

  "settings.aboutRiftCode.telemetry.title": "Telemetri",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Åpne innstillinger for telemetri",
  ...
  "settings.language.description": 'Velg språket for RiftAI-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migrering fra eldre versjon",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av RiftAI, inkludert API-nøkler for leverandører og standardmodell.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i RiftAI",
