...
export const dict = {
  ...
  "settings.config.source.homeKilocode": "主目錄 .riftcode 設定",
  ...
  "settings.config.source.projectKilocode": "舊版 .riftcode 設定",
  ...
  "profile.action.login": "使用 RiftAI 登入",
  ...
  "settings.aboutRiftCode.title": "關於 RiftAI",

  "session.messages.empty": "在下方輸入訊息以開始對話。",
  "session.messages.welcome": "RiftAI 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.aboutRiftCode.status.connected": "已連線",
  "settings.aboutRiftCode.status.connecting": "連線中...",
  "settings.aboutRiftCode.status.disconnected": "已中斷",
  "settings.aboutRiftCode.status.error": "錯誤",
  "settings.aboutRiftCode.cliServer": "CLI 伺服器",
  "settings.aboutRiftCode.status.label": "狀態：",
  "settings.aboutRiftCode.port.label": "連接埠：",
  "settings.aboutRiftCode.versionInfo": "版本資訊",
  "settings.aboutRiftCode.version.label": "版本：",
  "settings.aboutRiftCode.extensionName": "RiftAI 擴充功能",
  "settings.aboutRiftCode.community": "社群與支援",
  "settings.aboutRiftCode.feedback.prefix": "如果您有任何問題或回饋，歡迎在以下平台提交 issue",
  "settings.aboutRiftCode.feedback.or": "或",
  "settings.aboutRiftCode.support.prefix": "如有帳單或帳戶問題，請聯繫客戶支援",
  "settings.aboutRiftCode.resetSettings.title": "重置設定",
  "settings.aboutRiftCode.resetSettings.description":
    "此操作僅將 VS Code 擴充功能專屬設定重置為預設值。與 CLI 共享的設定（例如模式和自動核准規則）儲存在 CLI 設定中，不會被重置。",
  "settings.aboutRiftCode.resetSettings.button": "重置所有設定",
  "settings.aboutRiftCode.settingsTransfer.title": "設定轉移",
  "settings.aboutRiftCode.settingsTransfer.description": "匯出或匯入設定，以便在 VS Code 實例之間轉移。",
  "settings.aboutRiftCode.exportSettings": "匯出",
  "settings.aboutRiftCode.importSettings": "匯入",
  "settings.aboutRiftCode.importSettings.invalidJson": "無效的 JSON 檔案。請選擇有效的設定檔。",
  "settings.aboutRiftCode.importSettings.invalidConfig": "檔案不包含有效的 Kilo 設定。",
  "settings.aboutRiftCode.importSettings.tooLarge": "檔案過大。設定檔必須小於 1 MB。",
  "settings.aboutRiftCode.importSettings.newerVersion": "此檔案由較新版本的 Kilo 匯出。部分設定可能會被忽略。",
  "settings.aboutRiftCode.importSettings.success": "設定已匯入。請檢視上方的變更，然後點擊儲存。",

  "settings.aboutRiftCode.telemetry.title": "遙測",
  "settings.aboutRiftCode.telemetry.description":
    '遙測由 VS Code 內建的遙測設定控制。若要停用，請前往「設定」>「遙測」>「遙測層級」並將其設為 "off"。重新啟動 VS Code 以套用變更。',
  "settings.aboutRiftCode.telemetry.openSettings": "開啟遙測設定",
  ...
  "settings.language.description": "選擇 RiftAI 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.aboutRiftCode.legacyMigration.title": "舊版遷移",
  "settings.aboutRiftCode.legacyMigration.description":
    "從舊版 RiftAI 安裝遷移設定，包括供應商 API 金鑰和預設模型。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "RiftAI 新功能",
