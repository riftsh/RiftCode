...
export const dict = {
  ...
  "settings.config.source.homeKilocode": "主目录 .riftcode 配置",
  ...
  "settings.config.source.projectKilocode": "旧版 .riftcode 配置",
  ...
  "profile.action.login": "使用 RiftAI 登录",
  ...
  "settings.aboutRiftCode.title": "关于 RiftAI",

  "session.messages.empty": "在下方输入消息以开始对话。",
  "session.messages.welcome": "RiftAI 是一个 AI 编程助手。让它帮你构建功能、修复 bug 或解释代码库。",
  ...
  "settings.aboutRiftCode.status.connected": "已连接",
  "settings.aboutRiftCode.status.connecting": "连接中...",
  "settings.aboutRiftCode.status.disconnected": "已断开",
  "settings.aboutRiftCode.status.error": "错误",
  "settings.aboutRiftCode.cliServer": "CLI 服务器",
  "settings.aboutRiftCode.status.label": "状态：",
  "settings.aboutRiftCode.port.label": "端口：",
  "settings.aboutRiftCode.versionInfo": "版本信息",
  "settings.aboutRiftCode.version.label": "版本：",
  "settings.aboutRiftCode.extensionName": "RiftAI 扩展",
  "settings.aboutRiftCode.community": "社区与支持",
  "settings.aboutRiftCode.feedback.prefix": "如果您有任何问题或反馈，欢迎在以下平台提交 issue",
  "settings.aboutRiftCode.feedback.or": "或",
  "settings.aboutRiftCode.support.prefix": "如有账单或账户问题，请联系客户支持",
  "settings.aboutRiftCode.resetSettings.title": "重置设置",
  "settings.aboutRiftCode.resetSettings.description":
    "此操作仅将 VS Code 扩展专属设置重置为默认值。与 CLI 共享的设置（如模式和自动审批规则）存储在 CLI 配置中，不会被重置。",
  "settings.aboutRiftCode.resetSettings.button": "重置所有设置",
  "settings.aboutRiftCode.settingsTransfer.title": "设置迁移",
  "settings.aboutRiftCode.settingsTransfer.description": "导出或导入设置，以便在 VS Code 实例之间传输。",
  "settings.aboutRiftCode.exportSettings": "导出",
  "settings.aboutRiftCode.importSettings": "导入",
  "settings.aboutRiftCode.importSettings.invalidJson": "无效的 JSON 文件。请选择有效的设置文件。",
  "settings.aboutRiftCode.importSettings.invalidConfig": "文件不包含有效的 Kilo 设置。",
  "settings.aboutRiftCode.importSettings.tooLarge": "文件过大。设置文件必须小于 1 MB。",
  "settings.aboutRiftCode.importSettings.newerVersion": "此文件由较新版本的 Kilo 导出。部分设置可能会被忽略。",
  "settings.aboutRiftCode.importSettings.success": "设置已导入。请查看上方的更改，然后点击保存。",

  "settings.aboutRiftCode.telemetry.title": "遥测",
  "settings.aboutRiftCode.telemetry.description":
    '遥测由 VS Code 的内置遥测设置控制。若要将其禁用，请转到「设置」>「遥测」>「遥测级别」并将其设置为 "off"。重启 VS Code 以应用更改。',
  "settings.aboutRiftCode.telemetry.openSettings": "打开遥测设置",
  ...
  "settings.language.description": '"自动"将使用 VS Code 的显示语言。选择 RiftAI 界面的语言。',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "旧版迁移",
  "settings.aboutRiftCode.legacyMigration.description":
    "从旧版 RiftAI 安装迁移设置，包括提供商 API 密钥和默认模型。",
