export const dict = {
  ...
  "settings.config.source.homeKilocode": "Configuração .riftcode da Home",
  ...
  "settings.config.source.projectKilocode": "Configuração .riftcode legada",
  ...
  "deviceAuth.title": "Entrar no RiftAI",
  ...
  "profile.action.login": "Entrar com RiftAI",
  ...
  "settings.aboutRiftCode.title": "Sobre o RiftAI",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "RiftAI é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutRiftCode.status.error": "Erro",
  ...
  "settings.aboutRiftCode.versionInfo": "Informações da Versão",
  "settings.aboutRiftCode.version.label": "Versão:",
  "settings.aboutRiftCode.extensionName": "Extensão RiftAI",
  "settings.aboutRiftCode.community": "Comunidade e Suporte",
  "settings.aboutRiftCode.feedback.prefix": "Se você tiver perguntas ou feedback, abra uma issue no",
  ...
  "settings.aboutRiftCode.resetSettings.title": "Redefinir Configurações",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Redefinir Todas as Configurações",
  "settings.aboutRiftCode.settingsTransfer.title": "Transferência de configurações",
  ...
  "settings.aboutRiftCode.importSettings.invalidConfig": "O arquivo não contém configurações válidas do Kilo.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Abrir Configurações de Telemetria",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do RiftAI. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migração Legada",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do RiftAI, incluindo chaves de API de provedor e modelo padrão.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no RiftAI",
