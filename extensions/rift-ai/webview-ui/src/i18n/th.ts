export const dict = {
  ...
  "settings.config.source.homeKilocode": "การตั้งค่า .riftcode ของ Home",
  ...
  "settings.config.source.projectKilocode": "การตั้งค่า .riftcode แบบเก่า",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ RiftAI",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย RiftAI",
  ...
  "settings.aboutRiftCode.title": "เกี่ยวกับ RiftAI",

  "session.messages.empty": "เริ่มการสนทนาโดยพิมพ์ข้อความด้านล่าง",
  "session.messages.welcome": "RiftAI เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.aboutRiftCode.status.connected": "เชื่อมต่อแล้ว",
  "settings.aboutRiftCode.status.connecting": "กำลังเชื่อมต่อ...",
  "settings.aboutRiftCode.status.disconnected": "ตัดการเชื่อมต่อ",
  "settings.aboutRiftCode.status.error": "ข้อผิดพลาด",
  "settings.aboutRiftCode.cliServer": "เซิร์ฟเวอร์ CLI",
  "settings.aboutRiftCode.status.label": "สถานะ:",
  "settings.aboutRiftCode.port.label": "พอร์ต:",
  "settings.aboutRiftCode.versionInfo": "ข้อมูลเวอร์ชัน",
  "settings.aboutRiftCode.version.label": "เวอร์ชัน:",
  "settings.aboutRiftCode.extensionName": "ส่วนขยาย RiftAI",
  "settings.aboutRiftCode.community": "ชุมชนและการสนับสนุน",
  "settings.aboutRiftCode.feedback.prefix": "หากคุณมีคำถามหรือข้อเสนอแนะ สามารถเปิด issue ได้ที่",
  "settings.aboutRiftCode.feedback.or": "หรือ",
  "settings.aboutRiftCode.support.prefix": "สำหรับคำถามเกี่ยวกับการเรียกเก็บเงินหรือบัญชี ติดต่อฝ่ายสนับสนุนลูกค้าที่",
  "settings.aboutRiftCode.resetSettings.title": "รีเซ็ตการตั้งค่า",
  "settings.aboutRiftCode.resetSettings.description":
  ...
  "settings.aboutRiftCode.resetSettings.button": "รีเซ็ตการตั้งค่าทั้งหมด",
  "settings.aboutRiftCode.settingsTransfer.title": "ถ่ายโอนการตั้งค่า",
  "settings.aboutRiftCode.settingsTransfer.description":
    "ส่งออกหรือนำเข้าการตั้งค่าเพื่อถ่ายโอนระหว่างอินสแตนซ์ VS Code",
  "settings.aboutRiftCode.exportSettings": "ส่งออก",
  "settings.aboutRiftCode.importSettings": "นำเข้า",
  "settings.aboutRiftCode.importSettings.invalidJson": "ไฟล์ JSON ไม่ถูกต้อง กรุณาเลือกไฟล์การตั้งค่าที่ถูกต้อง",
  "settings.aboutRiftCode.importSettings.invalidConfig": "ไฟล์ไม่มีการตั้งค่า Kilo ที่ถูกต้อง",
  "settings.aboutRiftCode.importSettings.tooLarge": "ไฟล์มีขนาดใหญ่เกินไป ไฟล์การตั้งค่าต้องมีขนาดไม่เกิน 1 MB",
  "settings.aboutRiftCode.importSettings.newerVersion":
    "ไฟล์นี้ถูกส่งออกจาก Kilo เวอร์ชันใหม่กว่า การตั้งค่าบางรายการอาจถูกข้ามไป",
  "settings.aboutRiftCode.importSettings.success": "นำเข้าการตั้งค่าแล้ว ตรวจสอบการเปลี่ยนแปลงด้านบน จากนั้นคลิกบันทึก",

  "settings.aboutRiftCode.telemetry.title": "Telemetry",
  "settings.aboutRiftCode.telemetry.description":
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "เปิดการตั้งค่า Telemetry",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ RiftAI "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "การย้ายข้อมูลจากเวอร์ชันดั้งเดิม",
  "settings.aboutRiftCode.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง RiftAI ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",

  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน RiftAI",
