export const dict = {
  ...
  "settings.config.source.homeKilocode": "تكوين .riftcode في Home",
  ...
  "settings.config.source.projectKilocode": "تكوين .riftcode القديم",
  ...
  "deviceAuth.title": "تسجيل الدخول إلى RiftAI",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام RiftAI",
  ...
  "settings.aboutRiftCode.title": "حول RiftAI",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "RiftAI هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutRiftCode.status.connected": "متصل",
  "settings.aboutRiftCode.status.connecting": "جارٍ الاتصال...",
  "settings.aboutRiftCode.status.disconnected": "غير متصل",
  "settings.aboutRiftCode.status.error": "خطأ",
  "settings.aboutRiftCode.cliServer": "خادم CLI",
  "settings.aboutRiftCode.status.label": "الحالة:",
  "settings.aboutRiftCode.port.label": "المنفذ:",
  "settings.aboutRiftCode.versionInfo": "معلومات الإصدار",
  "settings.aboutRiftCode.version.label": "الإصدار:",
  "settings.aboutRiftCode.extensionName": "إضافة RiftAI",
  "settings.aboutRiftCode.community": "المجتمع والدعم",
  "settings.aboutRiftCode.feedback.prefix": "إذا كان لديك أي أسئلة أو ملاحظات، لا تتردد في فتح مشكلة على",
  "settings.aboutRiftCode.feedback.or": "أو",
  "settings.aboutRiftCode.support.prefix": "لأسئلة الفوترة أو الحساب، تواصل مع دعم العملاء على",
  "settings.aboutRiftCode.resetSettings.title": "إعادة تعيين الإعدادات",
  ...
  "settings.aboutRiftCode.resetSettings.button": "إعادة تعيين جميع الإعدادات",
  "settings.aboutRiftCode.settingsTransfer.title": "نقل الإعدادات",
  "settings.aboutRiftCode.settingsTransfer.description": "تصدير أو استيراد إعداداتك لنقلها بين نُسخ VS Code.",
  "settings.aboutRiftCode.exportSettings": "تصدير",
  "settings.aboutRiftCode.importSettings": "استيراد",
  "settings.aboutRiftCode.importSettings.invalidJson": "ملف JSON غير صالح. يرجى اختيار ملف إعدادات صالح.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "الملف لا يحتوي على إعدادات Kilo صالحة.",
  "settings.aboutRiftCode.importSettings.tooLarge": "الملف كبير جدًا. يجب أن تكون ملفات الإعدادات أقل من 1 MB.",
  "settings.aboutRiftCode.importSettings.newerVersion":
    "تم تصدير هذا الملف من إصدار أحدث من Kilo. قد يتم تجاهل بعض الإعدادات.",
  "settings.aboutRiftCode.importSettings.success": "تم استيراد الإعدادات. راجع التغييرات أعلاه، ثم انقر على حفظ.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "فتح إعدادات Telemetry",
  ...
  "settings.language.description": 'اختر اللغة لواجهة RiftAI. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "ترحيل الإصدار القديم",
  "settings.aboutRiftCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ RiftAI، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في RiftAI",
