export const dict = {
  ...
  "settings.config.source.homeKilocode": "Конфигурация .riftcode (Home)",
  ...
  "settings.config.source.projectKilocode": "Устаревшая конфигурация .riftcode",
  ...
  "deviceAuth.title": "Войти в RiftAI",
  ...
  "profile.action.login": "Войти через RiftAI",
  ...
  "settings.aboutRiftCode.title": "О RiftAI",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "RiftAI — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutRiftCode.status.connected": "Подключено",
  "settings.aboutRiftCode.status.connecting": "Подключение...",
  "settings.aboutRiftCode.status.disconnected": "Отключено",
  "settings.aboutRiftCode.status.error": "Ошибка",
  "settings.aboutRiftCode.cliServer": "CLI-сервер",
  "settings.aboutRiftCode.status.label": "Статус:",
  "settings.aboutRiftCode.port.label": "Порт:",
  "settings.aboutRiftCode.versionInfo": "Информация о версии",
  "settings.aboutRiftCode.version.label": "Версия:",
  "settings.aboutRiftCode.extensionName": "Расширение RiftAI",
  "settings.aboutRiftCode.community": "Сообщество и поддержка",
  "settings.aboutRiftCode.feedback.prefix": "Если у вас есть вопросы или отзывы, создайте issue на",
  "settings.aboutRiftCode.feedback.or": "или",
  "settings.aboutRiftCode.support.prefix": "По вопросам оплаты или аккаунта обращайтесь в службу поддержки по адресу",
  "settings.aboutRiftCode.resetSettings.title": "Сброс настроек",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Сбросить все настройки",
  "settings.aboutRiftCode.settingsTransfer.title": "Перенос настроек",
  ...
  "settings.aboutRiftCode.exportSettings": "Экспорт",
  "settings.aboutRiftCode.importSettings": "Импорт",
  "settings.aboutRiftCode.importSettings.invalidJson": "Недопустимый файл JSON. Выберите корректный файл настроек.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Файл не содержит допустимых настроек Kilo.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Файл слишком большой. Файлы настроек должны быть менее 1 MB.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Телеметрия",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Открыть настройки телеметрии",
  ...
  "settings.language.description": "Выберите язык интерфейса RiftAI. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Миграция с устаревшей версии",
  "settings.aboutRiftCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки RiftAI, включая API-ключи провайдеров и модель по умолчанию.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в RiftAI",
