export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode yapılandırması",
  ...
  "settings.config.source.projectKilocode": "Eski .riftcode yapılandırması",
  ...
  "deviceAuth.title": "RiftAI'a giriş yap",
  ...
  "profile.action.login": "RiftAI ile giriş yap",
  ...
  "settings.aboutRiftCode.title": "RiftAI Hakkında",

  "session.messages.empty": "Aşağıya bir mesaj yazarak sohbete başlayın.",
  "session.messages.welcome":
    "RiftAI bir yapay zeka kodlama asistanıdır. Özellik geliştirmesini, hata düzeltmesini veya kod tabanınızı açıklamasını isteyin.",
  ...
  "settings.aboutRiftCode.status.connected": "Bağlı",
  "settings.aboutRiftCode.status.connecting": "Bağlanıyor...",
  "settings.aboutRiftCode.status.disconnected": "Bağlantı Kesildi",
  "settings.aboutRiftCode.status.error": "Hata",
  "settings.aboutRiftCode.cliServer": "CLI Sunucusu",
  "settings.aboutRiftCode.status.label": "Durum:",
  "settings.aboutRiftCode.port.label": "Port:",
  "settings.aboutRiftCode.versionInfo": "Sürüm Bilgisi",
  "settings.aboutRiftCode.version.label": "Sürüm:",
  "settings.aboutRiftCode.extensionName": "RiftAI Uzantısı",
  "settings.aboutRiftCode.community": "Topluluk ve Destek",
  "settings.aboutRiftCode.feedback.prefix":
    "Herhangi bir sorunuz veya geri bildiriminiz varsa, lütfen şu adreste bir sorun açın:",
  "settings.aboutRiftCode.feedback.or": "veya",
  "settings.aboutRiftCode.support.prefix": "Faturalama veya hesap soruları için Müşteri Desteği ile iletişime geçin:",
  "settings.aboutRiftCode.resetSettings.title": "Ayarları Sıfırla",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Tüm Ayarları Sıfırla",
  "settings.aboutRiftCode.settingsTransfer.title": "Ayar Aktarımı",
  ...
  "settings.aboutRiftCode.exportSettings": "Dışa Aktar",
  "settings.aboutRiftCode.importSettings": "İçe Aktar",
  "settings.aboutRiftCode.importSettings.invalidJson": "Geçersiz JSON dosyası. Lütfen geçerli bir ayar dosyası seçin.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Dosya geçerli Kilo ayarları içermiyor.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Dosya çok büyük. Ayar dosyaları 1 MB altında olmalıdır.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Telemetri Ayarlarını Aç",
  ...
  "settings.language.description":
    '"Otomatik" VS Code görüntüleme dilinizi kullanır. RiftAI arayüzü için dil seçin.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Eski Sürüm Taşıma",
  "settings.aboutRiftCode.legacyMigration.description":
    "Sağlayıcı API anahtarları ve varsayılan model dahil olmak üzere RiftAI'un önceki yüklemesinden ayarları taşıyın.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "RiftAI'daki Yenilikler",
