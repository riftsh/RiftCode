export const dict = {
  ...
  "settings.config.source.homeKilocode": "Конфігурація .riftcode (Home)",
  ...
  "settings.config.source.projectKilocode": "Застаріла конфігурація .riftcode",
  ...
  "deviceAuth.title": "Увійти до RiftAI",
  ...
  "profile.action.login": "Увійти через RiftAI",
  ...
  "settings.aboutRiftCode.title": "Про RiftAI",

  "session.messages.empty": "Напишіть повідомлення нижче, щоб розпочати чат.",
  "session.messages.welcome":
    "RiftAI — це асистент з кодування на базі ШІ. Попросіть його розробити функцію, виправити помилку або пояснити вашу кодову базу.",
  ...
  "settings.aboutRiftCode.status.connected": "Підключено",
  "settings.aboutRiftCode.status.connecting": "Підключення...",
  "settings.aboutRiftCode.status.disconnected": "Відключено",
  "settings.aboutRiftCode.status.error": "Помилка",
  ...
  "settings.aboutRiftCode.versionInfo": "Інформація про версію",
  "settings.aboutRiftCode.version.label": "Версія:",
  "settings.aboutRiftCode.extensionName": "Розширення RiftAI",
  "settings.aboutRiftCode.community": "Спільнота і підтримка",
  "settings.aboutRiftCode.feedback.prefix": "Якщо у вас є питання або відгуки, будь ласка, відкрийте тікет на:",
  "settings.aboutRiftCode.feedback.or": "або",
  "settings.aboutRiftCode.support.prefix": "З питань виставлення рахунків або акаунту зверніться до служби підтримки:",
  "settings.aboutRiftCode.resetSettings.title": "Скидання налаштувань",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Скинути всі налаштування",
  "settings.aboutRiftCode.settingsTransfer.title": "Перенесення налаштувань",
  ...
  "settings.aboutRiftCode.exportSettings": "Експортувати",
  "settings.aboutRiftCode.importSettings": "Імпортувати",
  "settings.aboutRiftCode.importSettings.invalidJson":
    "Недійсний файл JSON. Будь ласка, виберіть дійсний файл налаштувань.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Файл не містить дійсних налаштувань Kilo.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Файл занадто великий. Файли налаштувань мають бути менше 1 МБ.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Телеметрія",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Відкрити налаштування телеметрії",
  ...
  "settings.language.description":
    '"Автоматично" використовує мову відображення VS Code. Виберіть мову для інтерфейсу RiftAI.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Перенесення зі старої версії",
  "settings.aboutRiftCode.legacyMigration.description":
    "Перенести налаштування з попередньої версії RiftAI, включаючи API-ключі провайдерів та стандартну модель.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Що нового в RiftAI",
