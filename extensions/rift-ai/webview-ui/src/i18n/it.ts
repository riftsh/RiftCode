export const dict = {
  ...
  "settings.config.source.homeKilocode": "Config home .riftcode",
  ...
  "settings.config.source.projectKilocode": "Config legacy progetto .riftcode",
  ...
  "deviceAuth.title": "Accedi a RiftAI",
  ...
  "profile.action.login": "Accedi con RiftAI",
  ...
  "settings.aboutRiftCode.title": "Informazioni su RiftAI",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "RiftAI è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutRiftCode.status.connected": "Connesso",
  "settings.aboutRiftCode.status.connecting": "Connessione...",
  "settings.aboutRiftCode.status.disconnected": "Disconnesso",
  "settings.aboutRiftCode.status.error": "Errore",
  "settings.aboutRiftCode.cliServer": "Server CLI",
  "settings.aboutRiftCode.status.label": "Stato:",
  "settings.aboutRiftCode.port.label": "Porta:",
  "settings.aboutRiftCode.versionInfo": "Informazioni versione",
  "settings.aboutRiftCode.version.label": "Versione:",
  "settings.aboutRiftCode.extensionName": "Estensione RiftAI",
  "settings.aboutRiftCode.community": "Community e supporto",
  "settings.aboutRiftCode.feedback.prefix": "Per domande o feedback, apri pure una issue su",
  "settings.aboutRiftCode.feedback.or": "oppure",
  "settings.aboutRiftCode.support.prefix": "Per domande su fatturazione o account, contatta il supporto clienti a",
  "settings.aboutRiftCode.resetSettings.title": "Ripristina impostazioni",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Ripristina tutte le impostazioni",
  "settings.aboutRiftCode.settingsTransfer.title": "Trasferimento impostazioni",
  "settings.aboutRiftCode.settingsTransfer.description":
    "Esporta o importa le impostazioni per trasferirle tra istanze VS Code.",
  "settings.aboutRiftCode.exportSettings": "Esporta",
  "settings.aboutRiftCode.importSettings": "Importa",
  "settings.aboutRiftCode.importSettings.invalidJson": "File JSON non valido. Seleziona un file impostazioni valido.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Il file non contiene impostazioni Kilo valide.",
  "settings.aboutRiftCode.importSettings.tooLarge": "File troppo grande. I file impostazioni devono essere sotto 1 MB.",
  ...
  "settings.aboutRiftCode.telemetry.title": "Telemetria",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Apri impostazioni telemetria",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia RiftAI. "Auto" usa la lingua di VS Code.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migrazione legacy",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di RiftAI, incluse API key dei provider e modello predefinito.",
  "migration.whatsNew.title": "Novità in RiftAI",
