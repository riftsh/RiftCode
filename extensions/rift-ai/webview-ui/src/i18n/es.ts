export const dict = {
  ...
  "settings.config.source.homeKilocode": "Configuración .riftcode de Home",
  ...
  "settings.config.source.projectKilocode": "Configuración heredada .riftcode",
  ...
  "deviceAuth.title": "Iniciar sesión en RiftAI",
  ...
  "profile.action.login": "Iniciar sesión con RiftAI",
  ...
  "settings.aboutRiftCode.title": "Acerca de RiftAI",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "RiftAI es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutRiftCode.status.connected": "Conectado",
  "settings.aboutRiftCode.status.connecting": "Conectando...",
  "settings.aboutRiftCode.status.disconnected": "Desconectado",
  "settings.aboutRiftCode.status.error": "Error",
  "settings.aboutRiftCode.cliServer": "Servidor CLI",
  "settings.aboutRiftCode.status.label": "Estado:",
  "settings.aboutRiftCode.port.label": "Puerto:",
  "settings.aboutRiftCode.versionInfo": "Información de versión",
  "settings.aboutRiftCode.version.label": "Versión:",
  "settings.aboutRiftCode.extensionName": "Extensión RiftAI",
  "settings.aboutRiftCode.community": "Comunidad y soporte",
  "settings.aboutRiftCode.feedback.prefix": "Si tienes preguntas o comentarios, abre un issue en",
  "settings.aboutRiftCode.feedback.or": "o",
  "settings.aboutRiftCode.support.prefix": "Para preguntas de facturación o cuenta, contacta al Soporte al Cliente en",
  "settings.aboutRiftCode.resetSettings.title": "Restablecer configuración",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Restablecer toda la configuración",
  "settings.aboutRiftCode.settingsTransfer.title": "Transferencia de ajustes",
  ...
  "settings.aboutRiftCode.exportSettings": "Exportar",
  "settings.aboutRiftCode.importSettings": "Importar",
  "settings.aboutRiftCode.importSettings.invalidJson":
    "Archivo JSON no válido. Seleccione un archivo de ajustes válido.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "El archivo no contiene ajustes válidos de Kilo.",
  "settings.aboutRiftCode.importSettings.tooLarge":
  ...
  "settings.aboutRiftCode.telemetry.title": "Telemetría",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Abrir configuración de telemetría",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de RiftAI. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Migración heredada",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de RiftAI, incluyendo las claves API de proveedores y el modelo predeterminado.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en RiftAI",
