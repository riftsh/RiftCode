export const dict = {
  ...
  "settings.config.source.homeKilocode": "Homeの.riftcode構成",
  ...
  "settings.config.source.projectKilocode": "旧.riftcode構成",
  ...
  "profile.action.login": "RiftAIでログイン",
  ...
  "settings.aboutRiftCode.title": "RiftAIについて",

  "session.messages.empty": "下にメッセージを入力して会話を始めましょう。",
  "session.messages.welcome":
    "RiftAIはAIコーディングアシスタントです。機能の構築、バグの修正、コードベースの説明を依頼できます。",
  ...
  "settings.aboutRiftCode.status.connected": "接続済み",
  "settings.aboutRiftCode.status.connecting": "接続中...",
  "settings.aboutRiftCode.status.disconnected": "切断",
  "settings.aboutRiftCode.status.error": "エラー",
  "settings.aboutRiftCode.cliServer": "CLIサーバー",
  "settings.aboutRiftCode.status.label": "ステータス：",
  "settings.aboutRiftCode.port.label": "ポート：",
  "settings.aboutRiftCode.versionInfo": "バージョン情報",
  "settings.aboutRiftCode.version.label": "バージョン：",
  "settings.aboutRiftCode.extensionName": "RiftAI拡張機能",
  "settings.aboutRiftCode.community": "コミュニティとサポート",
  "settings.aboutRiftCode.feedback.prefix": "ご質問やフィードバックがありましたら、お気軽にissueを作成してください",
  "settings.aboutRiftCode.feedback.or": "または",
  "settings.aboutRiftCode.support.prefix":
    "請求やアカウントに関するご質問は、カスタマーサポートまでお問い合わせください",
  "settings.aboutRiftCode.resetSettings.title": "設定をリセット",
  ...
  "settings.aboutRiftCode.resetSettings.button": "すべての設定をリセット",
  "settings.aboutRiftCode.settingsTransfer.title": "設定の移行",
  "settings.aboutRiftCode.settingsTransfer.description":
    "VS Code インスタンス間で設定を転送するには、エクスポートまたはインポートしてください。",
  "settings.aboutRiftCode.exportSettings": "エクスポート",
  "settings.aboutRiftCode.importSettings": "インポート",
  "settings.aboutRiftCode.importSettings.invalidJson":
    "無効な JSON ファイルです。有効な設定ファイルを選択してください。",
  "settings.aboutRiftCode.importSettings.invalidConfig": "ファイルに有効な Kilo の設定が含まれていません。",
  "settings.aboutRiftCode.importSettings.tooLarge": "ファイルが大きすぎます。設定ファイルは 1 MB 以下にしてください。",
  ...
  "settings.aboutRiftCode.telemetry.title": "テレメトリ",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "テレメトリ設定を開く",
  ...
  "settings.language.description": "RiftAI UIの言語を選択します。「自動」はVS Codeの表示言語を使用します。",
  ...
  "settings.aboutRiftCode.legacyMigration.title": "レガシー移行",
  "settings.aboutRiftCode.legacyMigration.description":
    "プロバイダーのAPIキーやデフォルトモデルなど、以前にインストールしたRiftAIから設定を移行します。",

  // Screen 1 — What's New
  "migration.whatsNew.title": "RiftAIの新機能",
