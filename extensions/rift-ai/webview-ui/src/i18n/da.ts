export const dict = {
  ...
  "settings.config.source.homeKilocode": "Home .riftcode konfiguration",
  ...
  "settings.config.source.projectKilocode": "Forældet .riftcode konfiguration",
  ...
  "deviceAuth.title": "Log ind på RiftAI",
  ...
  "profile.action.login": "Log ind med RiftAI",
  ...
  "session.messages.welcome":
    "RiftAI er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutRiftCode.status.connected": "Forbundet",
  "settings.aboutRiftCode.status.connecting": "Forbinder...",
  "settings.aboutRiftCode.status.disconnected": "Afbrudt",
  "settings.aboutRiftCode.status.error": "Fejl",
  ...
  "settings.aboutRiftCode.versionInfo": "Versionsinformation",
  "settings.aboutRiftCode.version.label": "Version:",
  "settings.aboutRiftCode.extensionName": "RiftAI-udvidelse",
  "settings.aboutRiftCode.community": "Fællesskab og support",
  "settings.aboutRiftCode.feedback.prefix":
    "Hvis du har spørgsmål eller feedback, er du velkommen til at åbne en issue på",
  "settings.aboutRiftCode.feedback.or": "eller",
  "settings.aboutRiftCode.support.prefix": "For fakturerings- eller kontospørgsmål, kontakt kundesupport på",
  "settings.aboutRiftCode.resetSettings.title": "Nulstil indstillinger",
  ...
  "settings.aboutRiftCode.resetSettings.button": "Nulstil alle indstillinger",
  "settings.aboutRiftCode.settingsTransfer.title": "Overførsel af indstillinger",
  ...
  "settings.aboutRiftCode.exportSettings": "Eksportér",
  "settings.aboutRiftCode.importSettings": "Importér",
  "settings.aboutRiftCode.importSettings.invalidJson": "Ugyldig JSON-fil. Vælg venligst en gyldig indstillingsfil.",
  "settings.aboutRiftCode.importSettings.invalidConfig": "Filen indeholder ikke gyldige Kilo-indstillinger.",
  "settings.aboutRiftCode.importSettings.tooLarge": "Filen er for stor. Indstillingsfiler skal være under 1 MB.",
  ...
  "settings.aboutRiftCode.telemetry.openSettings": "Åbn telemetriindstillinger",
  ...
  "settings.language.description": 'Vælg sproget til RiftAI-brugerfladen. "Auto" bruger VS Codes visningssprog.',
  ...
  "settings.aboutRiftCode.legacyMigration.title": "Legacy-migrering",
  "settings.aboutRiftCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af RiftAI, herunder udbyder API-nøgler og standardmodel.",

  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i RiftAI",
