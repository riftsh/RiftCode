...
import { Tabs } from "@riftcode/kilo-ui/tabs"
...
import AboutRiftCodeTab from "./AboutRiftCodeTab"
    ...
    <div style={{ display: "flex", "flex-direction": "column", height: "100%", "min-height": 0 }}>
      ...
      >
        <Tabs.List>
          ...
          <Tabs.Trigger value="aboutRiftCode">
            <Icon name="help" />
            <span class="label">{language.t("settings.aboutRiftCode.title")}</span>
          </Tabs.Trigger>
        </Tabs.List>
        ...
        <Tabs.Content value="aboutRiftCode">
          <h3>{language.t("settings.aboutRiftCode.title")}</h3>
          <AboutRiftCodeTab
