export const dict = {
  // App
  "kiloClaw.loading": "Caricamento di RiftClaw...",
  ...
  "kiloClaw.setup.description1":
    "RiftClaw ti offre un'AI personale che legge le email, gestisce il calendario, monitora i progetti e vive in Telegram, Slack, o dove lavori già.",
  ...
  "kiloClaw.setup.tryRiftClaw": "Prova RiftClaw",

  // Upgrade
  "kiloClaw.upgrade.title": "La chat di RiftClaw richiede un aggiornamento",
  ...
  "kiloClaw.upgrade.description2.after":
    " nella dashboard di RiftClaw per attivare la chat in tempo reale con il tuo bot.",
