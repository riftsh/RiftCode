export const dict = {
  // App
  "kiloClaw.loading": "Loading RiftClaw...",
  ...
  "kiloClaw.setup.description1":
    "RiftClaw gives you a personal AI that reads email, manages your calendar, monitors your projects, and lives in Telegram, Slack \u2014 whatever you already use.",
  ...
  "kiloClaw.setup.tryRiftClaw": "Try RiftClaw",

  // Upgrade
  "kiloClaw.upgrade.title": "RiftClaw Chat requires an upgrade",
  ...
  "kiloClaw.upgrade.description2.after": " button on the RiftClaw dashboard to activate real-time chat with your bot.",
