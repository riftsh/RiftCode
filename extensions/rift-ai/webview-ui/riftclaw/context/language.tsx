// RiftClaw lightweight language context
//
// Self-contained i18n for the RiftClaw panel. Does not depend on
...
export function RiftClawLanguageProvider(props: { locale: () => string | undefined; children: JSX.Element }) {
...
export function useRiftClawLanguage(): LanguageCtx {
  const ctx = useContext(LanguageContext)
  if (!ctx) throw new Error("useRiftClawLanguage must be used within RiftClawLanguageProvider")
  return ctx
}
