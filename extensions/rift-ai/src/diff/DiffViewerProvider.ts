...
export class DiffViewerProvider implements vscode.Disposable {
  public static readonly viewType = "rift-ai.new.DiffViewerPanel"
  ...
  /**
   * Entry point for the `rift-ai.new.showChanges` command. Composes the
  ...
  private onWebviewReady(): void {
    ...
    void this.panel.webview.postMessage({
      ...
      languageOverride: vscode.workspace.getConfiguration("rift-ai.new").get<string>("language"),
