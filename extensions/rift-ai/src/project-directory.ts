 ...
 * ## Why this exists
 *
 * The sidebar RiftProvider always uses `getWorkspaceDirectory()`, which returns
 ...
 *
 * ## How RiftProvider uses this
 *
 * Each RiftProvider instance can receive an explicit `projectDirectory` via
 * `RiftProviderOptions`. When set:
 *
...
/**
 * Resolve the effective project directory for a RiftProvider instance.
 *
 * @param override - Explicit directory from RiftProviderOptions. `undefined`
 ...
 *   `getWorkspaceDirectory(sessionId)` from RiftProvider).
 */
