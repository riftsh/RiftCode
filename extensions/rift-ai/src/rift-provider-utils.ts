import type { Session, Agent, Event, ProviderListResponse } from "@riftcode/sdk/v2/client"
import { prettifyError } from "zod/v4"
import type { CloudSessionMessage, IndexingStatus } from "./services/cli-backend/types"
import type { PartBatch, PartUpdate } from "./rift-provider/session-stream-scheduler"
import type { PartRemove } from "./shared/stream-messages"
import * as path from "path"

export { SessionStreamScheduler } from "./rift-provider/session-stream-scheduler"
...
/**
 * Shared interface for the subset of RiftProvider state needed by session-refresh helpers.
 * Extracted here so the logic can be tested without importing RiftProvider (and vscode).
 */
