...
export class VscodeHost implements Host {
  ...
  private wirePanel(
    ...
    panel.iconPath = {
      light: vscode.Uri.joinPath(this.extensionUri, "assets", "icons", "rift-ai-light.svg"),
      dark: vscode.Uri.joinPath(this.extensionUri, "assets", "icons", "rift-ai-dark.svg"),
    }
