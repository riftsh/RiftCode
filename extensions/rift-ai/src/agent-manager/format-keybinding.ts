...
const AM_PREFIX = "rift-ai.new.agentManager."

/** Global commands whose keybindings are forwarded to the webview. */
const GLOBAL_KEYBINDINGS: Record<string, string> = {
  "rift-ai.new.agentManagerOpen": "agentManagerOpen",
  "rift-ai.new.cycleAgentMode": "cycleAgentMode",
  "rift-ai.new.cyclePreviousAgentMode": "cyclePreviousAgentMode",
}
