...
export class SessionTerminalManager {
  ...
  constructor(
    ...
    this.disposables.push(
      ...
      host.onActiveTerminalChanged((terminal) => {
        ...
        void host.setContext("rift-ai.agentTerminalFocus", managed)
      }),
    )
  ...
  dispose(): void {
    void this.host.setContext("rift-ai.agentTerminalFocus", false)
  ...
  private updateContextKey(): void {
    ...
    void this.host.setContext("rift-ai.agentTerminalFocus", managed)
  }
