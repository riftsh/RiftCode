...
// equivalents in @riftcode/sdk. All API types (Session, Event, Agent,
// McpStatus, Config, etc.) should be imported from "@riftcode/sdk/v2/client".

import type { IndexingStatus as SdkIndexingStatus } from "@riftcode/sdk/v2/client"
