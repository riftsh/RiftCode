...
const SETTINGS_COMMAND = `command:rift-ai.new.settingsButtonClicked?${encodeURIComponent(JSON.stringify(["autocomplete"]))}`
...
export class AutocompleteStatusBar {
  ...
  private init() {
    this.statusBar.text = t("riftcode:autocomplete.statusBar.enabled")
    this.statusBar.tooltip = this.createMarkdownTooltip(t("riftcode:autocomplete.statusBar.tooltip.basic"))
    this.statusBar.show()
  }
  ...
  private renderDefault() {
    ...
    const snoozedSuffix = this.props.snoozed ? ` (${t("riftcode:autocomplete.statusBar.snoozed")})` : ""
    this.statusBar.text = `${t("riftcode:autocomplete.statusBar.enabled")} (${this.props.completionCount})${snoozedSuffix}`

    this.statusBar.tooltip = this.createMarkdownTooltip(
      [
        t("riftcode:autocomplete.statusBar.tooltip.completionSummary", {
        ...
        this.props.model && this.props.provider
          ? t("riftcode:autocomplete.statusBar.tooltip.providerInfo", {
  ...
  private renderNoUsableProviderError() {
    this.statusBar.text = t("riftcode:autocomplete.statusBar.warning")
    this.statusBar.tooltip = this.createMarkdownTooltip(
      t("riftcode:autocomplete.statusBar.tooltip.noUsableProvider", {
