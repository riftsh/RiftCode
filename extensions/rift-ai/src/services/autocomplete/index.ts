...
export const registerAutocompleteProvider = async (
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.reload", async () => {
      await autocompleteManager.load()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.codeActionQuickFix", async () => {
      return
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.cancelSuggestions", () => {
      vscode.commands.executeCommand("editor.action.inlineSuggest.hide")
      vscode.commands.executeCommand("setContext", "rift-ai.new.autocomplete.hasSuggestions", false)
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.generateSuggestions", async () => {
      autocompleteManager.codeSuggestion()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.showIncompatibilityExtensionPopup", async () => {
      await autocompleteManager.showIncompatibilityExtensionPopup()
    }),
  )
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.disable", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.nextEdit.acceptOrJump", async () => {
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("rift-ai.new.autocomplete.nextEdit.dismiss", () => {
  ...
  context.subscriptions.push(
    vscode.workspace.onDidChangeConfiguration((e) => {
      if (e.affectsConfiguration("rift-ai.new.autocomplete")) {
